        ...
        <div class="tabel">
            <div class="tabel-content doc-content">
                <div class="doc-header">
                    <div class="d-flex">
                        <span><a href="tabelguru.php"><i class="fa fa-arrow-left"></i></a> </span>
                ...
                <div class="add-docs tambah-tugas">
                    <form action="" method="post" enctype="multipart/form-data" class="dropzone" id="image-upload">
                        ...
                        $Id = $_GET['Id'];
                        $siswa = query("SELECT * FROM user_guru WHERE Id = $Id");

                        ?>
                        <div class="title d-flex">
                            <p>Nama Guru</p>
                            <input name="nama" value="<?php echo $siswa["Nama"] ?>" type="text" placeholder="Ketikkan nama guru disini" required>
                        </div>
                        <div class="title d-flex">
                            <p>Nip</p>
                            <input name="nip" value="<?php echo $siswa["Nip"] ?>" type="text" placeholder="Ketikkan nip guru disini" required>
                        </div>
                        <div class="title d-flex">
                            <p>Posisi</p>
                            <input name="posisi" value="<?php echo $siswa["Posisi"] ?>" type="text" placeholder="Ketikkan posisi guru disini (Mis: Guru Mapel)" required>
                        </div>
                        <div class="title d-flex">
                            <p>TTL</p>
                            <div class="waktu">
                                <input name="tempat" value="<?php echo $siswa["Tempat"] ?>" style="width:200px;" type="text" placeholder="Ketikkan tempat lahir guru disini">
                                <input name="tanggal" type="date" value="<?php echo $siswa["Tanggal"] ?>" placeholder="Ketikkan tanggal lahir guru disini" required>

                            </div>
                        </div>
                        <div class="title d-flex">
                            <p>Alamat</p>
                            <input name="alamat" value="<?php echo $siswa["Alamat"] ?>" type="text" placeholder="Ketikkan alamat guru disini (opsional)">
                        </div>
                        <div class="title d-flex">
                            <p>Email</p>
                            <input name="email" type="text" value="<?php echo $siswa["Email"] ?>" placeholder="Ketikkan email guru disini (opsional)">
                        </div>
                        <div class="title d-flex">
                            <p>Username</p>
                            <input name="username" type="text" value="<?php echo $siswa["Username"] ?>" placeholder="Ketikkan username guru disini" required>
                        </div>
                        <div class="title d-flex">
                            <p>Password</p>
                            <input name="password" type="text" value="<?php echo $siswa["Password"] ?>" placeholder="Ketikkan password guru disini" required>
                        </div>
                        <div class="title d-flex">
                            <p>Profil (Opsional)</p>
                        ...
                        <div class="click">
                            <div class="btn-back">
                                <button onclick=""><a style="color: white; text-decoration: none;" href="tabelguru.php">Kembali</a></button>
                            </div>
                            <div class="btn-start">

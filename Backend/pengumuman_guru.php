...
if (isset($_POST['pengumuman'])) {
    $conn = koneksi();
    header("Location: tambahpengumuman.php?Id=$Id_Mapel");
}

$p = querys("SELECT * FROM pengumuman  WHERE Id_Mapel = '$Id_Mapel'");
if (isset($_POST['cari'])) {
    $p = cari_pengumuman($_POST['keyword']);
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="doc-header">
                    <div class="d-flex">
                        ...
                        <div class="btn-start ml-auto upload-btn-wrapper kumpul">
                            <form action="" method="post">
                                <button type="submit" name="pengumuman">Tambah Pengumuman</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <?php foreach ($p as $p) : ?>
                        <div class="tugas-list-item">
                            <div class="title-tugas d-flex">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div id="drop-history" class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Pengemumuman Ini?')" href="hapuspengumuman.php?Id=<?= $p["Id_Pengumuman"] ?>">Delete Pengumuman</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="btn-start ml-auto">
                                <button onclick="location.href='detailpengumuman_guru.php?Id=<?= $p["Id_Pengumuman"] ?>'">Detail</button>
                            </div>
                        </div>
                    <?php endforeach ?>
                </div>

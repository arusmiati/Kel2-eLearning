...
<body>
  ...
  <!-- HEADER -->
  <div class="header">
    <a id="back" href="homepage.php">&#10094;</a>
    <a id="back" href="homepage.php">Announcement</a>
  </div>
  <div id="confirm-box">
      ...
      <?php $i=1; foreach ($a as $i => $a): ?>
        <?php if($i==0){ ?>
          <li class="active">
            ...
            <div class="swiper-slide" style="background: url(img_homepage/<?php echo $a["image"]?>) no-repeat; background-position: 50%;background-size: cover;">  
              ...
              <a style="text-decoration: none;" href="#section<?php echo $i; ?>" data-toggle="tab"><h5><?php echo $a['judul']; ?></h5></a>
              <a style="text-decoration: none;color:black;" href="#section<?php echo $i; ?>" data-toggle="tab"><p><?= substr($a["deskripsi"],0,70)?>...</p></a>
            </div>  
            </a>
			    </li>
        ...
        <?php }else{ ?>
            ...
            <div class="swiper-slide" style="background: url(img_homepage/<?php echo $a["image"]?>) no-repeat; background-position: 50%;background-size: cover;">
              ...
              <a style="text-decoration: none;" href="#sectionB<?php echo $i; ?>" data-toggle="tab"><h5><?php echo $a['judul']; ?></h5></a>
              <a style="text-decoration: none;color:black;" href="#sectionB<?php echo $i; ?>" data-toggle="tab"><p><?= substr($a["deskripsi"],0,70)?>...</p></a> 
            </div>  
            </a></li>
        <?php } ?>
      <?php endforeach ?>
  ...
  <div class="details">
    ...
    <?php $i = 1; foreach($al as $i => $al):  ?>
      <?php if($i==0){ ?>
        <div class="tab-pane text active" id="section<?php echo $i; ?>">
          <div class="content">
          <div class="image col-md-3" style="background:url(img_homepage/<?php echo $a["image"]?>) no-repeat; background-position: 50%;background-size: cover ;"></div>

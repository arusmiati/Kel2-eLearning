...
$idm = $tugas["Id_Mapel"];
$siswa = query("SELECT * FROM siswa_terdaftar WHERE Id_Kelas = $idm");
$kumpul = querys("SELECT * FROM kumpul_tugas WHERE Id_Tugas = '$Id'");
?>
                        ...
                        <table>
                            ...
                            foreach ($kumpul as $k) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href=""></a>
                                        <a href="download.php?filename=<?= $k["Lampiran"] ?>"><i class="fa fa-download"></i></a>
                                    </td>

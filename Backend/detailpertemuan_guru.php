...
if (isset($_POST['TambahAlur'])) {
  $conn = koneksi();
  header("Location: tambahalur.php?Id=$Id");
}
      ...
      <div class="detail-alur row">
        <div class="col-md-3">
          <div class="header d-flex" style="color: white;">
            <span><a href="alur_guru?Id=<?= $alurs["Id_Mapel"] ?>"><i class="fa fa-arrow-left"></i></a>
            </span>
            <h4><?= $alurs["Judul"] ?></h4>
          </div>
          <div class="tambah-materi">
            ...
            <div class="btn-start ml-auto">
              <button onclick="location.href='tambahmaterialur.php?Id=<?php echo $alurs["Id_Alur"] ?>'">
                <p>+ Tambah Materi</p>
              </button>
            </div>
          </div>
          ...
          <ul class="nav alur-nav nav-pills flex-column" id="experienceTab" role="tablist">
            ...
            foreach ($alur as $i => $a) : ?>
              <?php if ($i == 0) { ?>
                <li class="active"><a data-toggle="tab" href="#section<?php echo $i; ?>"><?php echo $a['Nama']; ?></a></li>
              <?php } else { ?>
                <li><a data-toggle="tab" href="#sectionB<?php echo $i; ?>"><?php echo $a['Nama']; ?></a></li>
              <?php } ?>
            <?php endforeach ?>
          </ul>
        </div>

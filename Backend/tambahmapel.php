        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="mapel nav-item">
                    <a href="kelas.html" class="btn" aria-hidden="true">Kelasku</a>
                </li>
                <li class="search-mapel nav-item">
                    <a href="tambahmapel.php" class="btn active" aria-hidden="true">Tambah Kelas</a>
                </li>
                ...
                <div class="detail-header d-flex">
                    ...
                    <div class="dropdown ml-auto">
                        ...
                        <div id="drop-history" class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="#">Semester Ganjil</a>
                            <a class="dropdown-item" href="#">Semester Genap</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="list-mapel-item">
                        ...
                        <div class="jlh-siswa d-flex">
                            ...
                            <div class="btn-detail">
                                <button onclick="location.href='detailkelas.php?Id=<?= $k['Id']; ?>'">Detail</button>
                            </div>
                        </div>   
                    </div>
                <?php endforeach; ?>

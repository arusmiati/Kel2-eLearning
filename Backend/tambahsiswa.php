                ...
                <div class="add-docs tambah-tugas">
                    <form action="" method="post" enctype="multipart/form-data" class="dropzone" id="image-upload">
                        ...
                        <div class="title d-flex">
                            <p>Nama Siswa</p>
                            <input name="nama" type="text" placeholder="Ketikkan nama siswa disini">
                        </div>
                        <div class="title d-flex">
                            <p>Nis</p>
                            <input name="nis" type="text" placeholder="Ketikkan nis siswa disini" require>
                        </div>
                        <div class="title d-flex">
                            <p>Kelas</p>
                            <input name="kelas" type="text" placeholder="Ketikkan kelas siswa disini (Mis: X Mipa 1)" require>
                        </div>
                        <div class="title d-flex">
                            <p>TTL</p>
                            <div class="waktu">
                                <input name="tempat" style="width:200px;" type="text" placeholder="Ketikkan tempat lahir siswa disini">
                                <input name="tanggal" type="date" placeholder="Ketikkan tempat lahir siswa disini">

                            </div>
                        </div>
                        <div class="title d-flex">
                            <p>Alamat</p>
                            <input name="alamat" type="text" placeholder="Ketikkan alamat siswa disini (opsional)">
                        </div>
                        <div class="title d-flex">
                            <p>Email</p>
                            <input name="email" type="text" placeholder="Ketikkan email siswa disini (opsional)">
                        </div>
                        <div class="title d-flex">
                            <p>Username</p>
                            <input name="username" type="text" placeholder="Ketikkan username siswa disini">
                        </div>
                        <div class="title d-flex">
                            <p>Password</p>
                            <input name="password" type="text" placeholder="Ketikkan password siswa disini">
                        </div>
                        <div class="title d-flex">
                            <p>Profil (Optional)</p>

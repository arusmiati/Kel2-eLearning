        ...
        <div class="add-docs tambah-tugas">
          <form action="" method="post">
            <div class="title d-flex">
              <p>Judul</p>
              <input name="judul" type="text" placeholder="Ketikkan judul tautan disini">
            </div>
            <div class="title d-flex" id="link-tautan">
              <p>Link URL</p>
              <input name="url" type="text" placeholder="Salin link URL disini">
            </div>
            <div class="click">
              <div class="btn-back">
              ...
              <div class="btn-start">
                <button type="submit" name="tautan" onclick="tambahConfirm()">Tambah</button>
              </div>
            </div>
          </form>
        </div>

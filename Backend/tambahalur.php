...
<head>
  ...
  <title>Tambah Alur Pertemuan</title>
...
<body>
  ...
  <div class="main-container">
    ...
    <div id="confirm-box-tambah">
      <h1>Alur Pertemuan Ini<br> Berhasil Ditambahkan</h1>
    </div>
    <div class="dokumen">
        ...
        <div class="add-docs tambah-alur">
          <form action="" method="post" enctype="multipart/form-data">
            <div class="title d-flex">
              <p>Judul</p>
              <input name="Judul" type="text" placeholder="Ketikkan judul dokumen disini">
            </div>
            ...
            <div class="click">
              ...
              <div class="btn-start">
                <button type="submit" name="alur" onclick="tambahConfirm()">Tambah</button>
              </div>
            </div>
          </form>
        </div>
  ...
  <script>
    ...
    function tambahConfirm() {
      if (c == 0) {
        ...
        setTimeout(() => {
          window.location.href = 'alur_guru.html'
        }, 3000);
        c = 1;
      } else {

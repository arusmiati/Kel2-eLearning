          ...
          <div class="doc-header">
            <div class="d-flex">
              ...
              <div class="btn-start ml-auto">
                <button onclick="location.href='tambah_forumthread_guru.php?Id=<?= $f["Id_ForumCat"] ?>'" type="submit" name="TambahForum">Tambah</button>
              </div>
            </div>
                  ...
                  <div class="forumthread-description">
                    <div class="dropdown">
                      ...
                      <div id="drop-history" class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="edit_forumthread_guru.php?Id=<?= $forum["Id_ForumThr"] ?>">Edit</a>
                        <a class="dropdown-item" onclick="return confirm('Apakah anda yakin ingin menghapus thread ini?');" href="hapusforumthread.php?Id=<?= $forum["Id_ForumThr"] ?>">Delete</a>
                      </div>
                    </div>
                    ...
                    <div class="buttom d-flex">
                      ...
                      <div class="btn-reply">
                        <button onclick="location.href='tambahkomentar_guru.php?Id=<?= $forum['Id_ForumThr']; ?>'">Reply</button>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="sub-item d-flex">
                        ...
                        <div class="forumthread-description">
                          <div class="dropdown">
                            ...
                            <div id="drop-history" class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                              <a class="dropdown-item" href="edit_forumreply_guru.php?Id=<?= $r["Id_Reply"] ?>">Edit</a>
                              <a class="dropdown-item" onclick="return confirm('Apakah anda yakin ingin menghapus thread ini?');" href="hapusforumreply.php?Id=<?= $r["Id_Reply"] ?>">Delete</a>
                            </div>
                          </div>
                          ...
                          <div class="buttom d-flex">
                            ...
                            <div class="btn-reply">
                              <button onclick="location.href='tambahreply_guru.php?Id=<?= $r['Id_Reply']; ?>'">Reply</button>
                            </div>
                          </div>
                        </div>
                      </div>

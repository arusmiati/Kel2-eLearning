...
if (isset($_POST['submit'])) {
    if (EditPassword2($_POST) > 0) {
        header("Location:password_admin.php?Id=$id");
    } else {
...
<body>
    ...
    <div class="profil-header">
        <div class="profil-sidebar">
            <div class="button">
                <button type="button" id="user" class="profil-sidebar-page" onclick="location.href='profil_admin.php'">
        ...
        <div class="profil-user">
            ...
            <div class="container-field-user pass" action="">
                <form class="field-user" action="" method="POST">
                    ...
                    <button class="batal" onclick="location.href='homepage_admin.php'"><a style="color: white; text-decoration: none;" href="homepage_admin.php">Batalkan</a></button>
                </form>
            </div>
        </div>
    </div>

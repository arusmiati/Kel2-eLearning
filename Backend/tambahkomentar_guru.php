...
if (isset($_POST['Forum'])) {
  if (TambahReply($_POST) > 0) {
    header("Location:forumthread_guru.php?Id=$Id");
  } else {
    echo '<script> alert: "Forum Categories Gagal Ditambahkan" </script>';
  }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="mapel nav-item">
          <a href="matapelajaran.html" class="btn active" aria-hidden="true">Kelasku</a>
        </li>
        <li class="search-mapel nav-item">
          <a href="pencarian.html" class="btn" aria-hidden="true">Pencarian Kelas</a>
        </li>
  ...
  <div class="main-container">
    ...
    <div id="confirm-box-tambah">
      <h1>Reply<br> Berhasil Ditambahkan</h1>
    </div>
    <div class="dokumen">
      ...
      <div class="doc-content">
        <div class="doc-header d-flex">
          <span><a href="forumthread.html"><i class="fa fa-arrow-left"></i></a> </span>
          <h1>Reply</h1>
        ...
        <div class="forumthread-list">
          <div class="forumthread-content">
            <div class="main-item">
              ...
              <div class="tambah-komentar">
                ...
                <div class="forumthread" style="padding-bottom: 1vh;">
          ...
          <div class="add-docs tambah-tugas reply">
            <form action="" method="post" enctype="multipart/form-data" class="dropzone" id="image-upload">
              <div class="title d-flex">
                <p>Judul</p>
                <input class="forum" name="forum" type="text" value="<?= $forum["Judul"]?>" placeholder="Ketikkan judul forum disini">
              </div>
  ...
  <script>
    ...
    function tambahConfirm() {
      if (c == 0) {
        ...
        setTimeout(() => {
          window.location.href = 'forumthread.html'
        }, 3000);
        c = 1;
      } else {

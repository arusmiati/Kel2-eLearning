            ...
            <div class="tabel-content doc-content">
                ...
                <div class="add-docs tambah-tugas">
                    ...
                    <div class="title d-flex">
                        <p>Judul</p>
                        <input name="judul" type="text" placeholder="Ketikkan judul materi disini">
                    </div>
                    ...
                    <div class="click">
                        ...
                        <div class="btn-start">
                            <button type="submit" name="docs" onclick="tambahConfirm()">Tambah</button>
                        </div>
                    </div>
                    </form>
                </div>     

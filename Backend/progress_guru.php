...
<head>
    ...
    <style>
        ...
        .progres-bar11 progress::after,
        .progres-bar21 progress::after,
        .progres-bar31 progress::after {
            width: 0% !important;
        }
    </style>
</head>
    ...
    <div class="main-container">
        ...
        <div class="sidebar" id="sidebar">
            <ul>
                ...
                <li class="icon">
                    <a href="logout.php" onclick="LogConfirm()"><img src="img/logout.png" alt=""></a>
                    <br>
                    <span>Logout</span>
                </li>
            </ul>
        </div>
        <div class="main-content-progres">
            <div class="progres">
                <div class="progres-header">
                    <h2 class="progres-title">Status Mata Pelajaran</h2>
                    <ul class="progres-xp ">
                        <li><img src="img/xp.png" alt=""></li>
                        <li>
                            <h2>150 XP</h2>
                        </li>
                    </ul>
            ...
            <div class="progres-content">
                <div class="progres-item">
                    <ul>
                        <li class="progres-name">MATEMATIKA WAJIB X MIPA 6</li>
                        <li class="progres-subitem">
                            <p class="tprogress">Alur Pembelajaran</p>
                            <p class="progres-bar1"><progress value="0" max="100"></progress></p>
                            <p>100%</p>
                        </li>
                        <li class="progres-subitem">
                            <p class="tprogress">Ujian</p>
                            <p class="progres-bar3"><progress value="0" max="100"></progress></p>
                            <p>100%</p>
                        </li>
                    </ul>
                </div>
                <div class="progres-item">
                    <ul>
                        <li class="progres-name">KIMIA X MIPA 6</li>
                        <li class="progres-subitem">
                            <p class="tprogress">Alur Pembelajaran</p>
                            <p class="progres-bar1 progres-bar11"><progress value="0" max="100"></progress></p>
                            <p>0%</p>
                        </li>
                        <li class="progres-subitem">
                            <p class="tprogress">Ujian</p>
                            <p class="progres-bar3 progres-bar31"><progress value="0" max="100"></progress></p>
                            <p>0%</p>
                        </li>
                    </ul>
                </div>

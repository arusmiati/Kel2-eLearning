...
$Nis = $_SESSION['Nis'];
$kelas = query("SELECT * FROM siswa_terdaftar JOIN matapelajaran ON siswa_terdaftar.Id_Kelas = matapelajaran.Id_kelas WHERE Nis = '$Nis' and Semester = 'Genap'");
                    ...
                    <div class="list-mapel-item">
                        ...
                        <div class="jlh-siswa d-flex">
                            ...
                            <div class="btn-detail">
                                <button onclick="location.href='detailmapel.php?Id=<?= $k["Id_Mapel"] ?>'">Detail</button>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>

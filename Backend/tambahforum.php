        ...
        <div class="add-docs tambah-tugas">
          <form action="" method="post" enctype="multipart/form-data" class="dropzone" id="image-upload">
            <div class="title d-flex">
              <p>Judul Forum</p>
              <input name="forum" type="text" placeholder="Ketikkan judul forum disini">
            </div>
            <div class="click">
              <div class="btn-back">
                <button onclick="location.href='forum_guru.html'">Kembali</button>
              </div>
              <div class="btn-start">
                <button type="submit" name="Forum" onclick= return "tambahConfirm()">Tambah</button>
              </div>
            </div>
          </form>
        </div>

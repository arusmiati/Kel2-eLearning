...
$Id_Mapel = $_GET["Id"];
$ujian = query("SELECT * FROM ujian  WHERE Id_Mapel = '$Id_Mapel'");
...
if (isset($_POST['tambah'])) {
    if (TambahSoal($_POST) > 0) {
        header("Location:tambahujian.php?Id=$id");
    } else {
        echo 'Tugas Gagal Ditambahkan';
    }
}
...
<body>
    ...
    <div class="main-container">
        ...
        <div id="confirm-box-tambah">
            <h1>Soal Ujian<br> Berhasil Ditambahkan</h1>
        </div>
        <div class="tabel">
            <div class=" tabel-content doc-content">
                <div class="doc-header d-flex">
                    ...
                    <h1>Tambah Ulangan Harian</h1>
                </div>
                <div class="add-docs tambah-ujian">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="title d-flex">
                        <p>Judul </p>
                        <input name="judul" type="text" placeholder="Ketikkan judul ulangan disini">
                    </div>
                    <div class="title d-flex">
                        <p>Waktu Aktif</p>
                        <input name="start" type="datetime-local" class="date">
                    </div>
                    <div class="title d-flex">
                        <p>Waktu Berakhir</p>
                        <input name="end" type="datetime-local" class="date">
                    </div>
                    <div class="title d-flex">
                        <p>Durasi</p>
                        <select name="durasi" class="pilihDurasi">
                            <option value="30Menit">30 Menit</option>
                            <option value="45Menit">45 Menit</option>
                            <option value="60Menit">60 Menit</option>
                            <option value="90Menit">90 Menit</option>
                            <option value="120Menit">120 Menit</option>
                    ...
                    <div class="click">
                        <div class="btn-back">
                            <button onclick="location.href='ujian_guru.html'">Kembali</button>
                        </div>
                        <div class="btn-start">
                            <button type="submit" name="ujian">Tambah</button>
                        </div>
                    </div>
                </form>
                </div>     
    ...
    <script>
        ...
        function tambahConfirm() {
            if (c == 0) {
                ...
                setTimeout (()=>{
                    window.location.href='ujian_guru.html'
                },3000); 
                c = 1;
            }
            else {

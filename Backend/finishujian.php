...
$nama = $_SESSION['Nama'];
$ujian = query("SELECT * FROM jawaban_ujian WHERE id_ujian = '$Id_Mapel' AND nama = '$nama' LIMIT 1");
        ...
        <div class="tabel">
            <div class="tabel-content">
                ...
                <div class="btn-back back-guru">
                    ...
                    $idm = $det_uj["Id_Mapel"] ?>
                    <button onclick="location.href='detailmapel.php?Id=<?=$idm?>'">Back to Class</button>
                </div>

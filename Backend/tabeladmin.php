...
if (isset($_POST['save'])) {
    ...
    for ($i = 0; $i < count($checkbox); $i++) {
        $del_id = $checkbox[$i];
        mysqli_query($conn, "DELETE FROM user_admin WHERE Id ='" . $del_id . "'");
            ...
            <div class="tabel-content">
                <div class="doc-header kelola d-flex">
                    <div class="head d-flex">
                        ...
                        <div class="icon"><img src="img/admin1.png" alt=""></div>
                        <?php
                        $conn = koneksi();
                        $user = "SELECT COUNT(*) FROM user_admin";
                ...
                <form action="" method="post" id="delete_form">
                    ...
                    <div class="del-sel">
                        ...
                        <button onclick="location.href='tambahguru.php'" style="background: #58BAAB;color: white;outline: none;cursor: pointer;"><a style="text-decoration: none;color: white;" href="tambahadmin.php">Tambah Data Admin</a></button>
                    </div>
                    <div class="item-tabel">
                        <table>
                            ...
                            <?php
                            $user = querys("SELECT * FROM user_admin");
                            if (isset($_POST['cari'])) {
                                $user = cari_admin($_POST['keyword']);
                            }
                            foreach ($user as $u) : ?>
                                <tr class="item items">
                                    <td><input type="checkbox" id="checkItem" name="check[]" value="<?= $u["Id"] ?>"></td>
                                    ...
                                    <td>
                                        <div class="opsi">
                                            <button class="edit" onclick="location.href='editadmin.php?Id=<?= $u["Id"] ?>'"><a href="editadmin.php?Id=<?= $u["Id"] ?>">edit</a></button>
                                        </div>
                                    </td>

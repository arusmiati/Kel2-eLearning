...
<body>
    ...
    <div class="profil-header">
        <div class="profil-sidebar">
            <div class="button">
                <button type="button" id="user" class="profil-sidebar-page" onclick="location.href='profil_admin.php?Id=<?= $user["Id"] ?>'"">
        ...
        <div class="profil-user">
            ...
            <form class="field-user" id="form" action="" method="POST" enctype="multipart/form-data">
                <div class="container-field-user" action="">
                    ...
                    <input type="file" onchange="preview();" name="Sampul" class="image" accept=".jpg, .jpeg, .png" id="alamat">

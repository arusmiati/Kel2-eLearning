            ...
            <div class="tabel-content doc-content">
                ...
                <div class="add-docs tambah-tugas">
                    ...
                    <div class="title d-flex">
                        <p>Judul</p>
                        <input value="<?= $docs["Materi"]?>" name="judul" type="text" placeholder="Ketikkan judul materi disini">
                    </div>
                    <div class="title tambah d-flex">
                            <p>Tambah File</p>
                            <input id="upfile" type="file" value="<?= $docs["Judul"]?>"  name="NamaFile" multiple />
                        </div>
                    <div class="click">
                        <div class="btn-back">
                        ...
                        <div class="btn-start">
                            <button type="submit" name="docs" onclick="tambahConfirm()">Edit</button>
                        </div>
                    </div>
                    </form>
                </div>     

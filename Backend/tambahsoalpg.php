            ...
            <div class=" doc-content">
                ...
                <div class="add-docs tambah-alur">
                    <form action="" method="post" enctype="multipart/form-data" class="dropzone" id="image-upload">
                        ...
                        <div class="title d-flex">
                            <p>Opsi 1</p>
                            <input name="opsi1" type="text" placeholder="Ketikkan opsi disini">
                        </div>
                        <div class="title d-flex">
                            <p>Opsi 2</p>
                            <input name="opsi2" type="text" placeholder="Ketikkan opsi disini">
                        </div>
                        <div class="title d-flex">
                            <p>Opsi 3</p>
                            <input name="opsi3" type="text" placeholder="Ketikkan opsi disini">
                        </div>
                        <div class="click">
                            <div class="btn-back">

...
<body>
    <?php require_once('navbar/navbarsistem_admin.php') ?>
                ...
                <form action="" method="post" id="delete_form">
                    ...
                    <div class="item-tabel">
                        <table>
                            ...
                            <?php
                            $user = querys("SELECT * FROM user_siswa ORDER BY last_login DESC");
                            if (isset($_POST['cari'])) {
                                $user = cari_siswa2($_POST['keyword']);
                            }
                            foreach ($user as $u) : ?>
                                <tr class="item items">
                                    ...
                                    <?php }else{ ?>
                                        <td style="color: red;">Deactived</td>
                                    <?php } ?>

    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="mapel nav-item">
          <a href="matapelajaran.php" class="btn active" aria-hidden="true">Mata Pelajaran</a>
        </li>
    ...
    <div class="dokumen">
      ...
      <div class="doc-content">
        <div class="doc-header d-flex">
          <span><a href="<?= $previous ?>"><i class="fa fa-arrow-left"></i></a> </span>
        ...
        <div class="add-docs tambah-tugas thread">
          <form action="" method="post" enctype="multipart/form-data" class="dropzone" id="image-upload">
            <div class="title d-flex">
              <p>Judul Forum</p>
              <input value="<?=$forum["JudulReply"] ?>" class="forum" name="forum" type="text" placeholder="Ketikkan judul forum disini">
            </div>
            <div class="title title-thread d-flex">
              <p class="forum-desk">Deskripsi</p>
              <div class="add-thread" id="add-thread">
                <textarea name="editor"><?= $forum["DeskripsiReply"] ?></textarea>
              </div>
            </div>
            <div class="click">
              <div class="btn-back">
              ...
              <div class="btn-start">
                <button name="Forum" type="submit">Edit</button>
              </div>
            </div>
          </form>
        </div>

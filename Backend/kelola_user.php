    ...
    <div class="main-container">
        ...
        <div class="tabel">
            <div class="tabel-content">
                ...
                <div class="title-kelola">
                    <h1>E-LEARNING SMANEL USERS</h1>
                </div>
                <div class="item-kelola">
                    <button class="kelola-siswa" onclick="location.href='tabelsiswa.php'">
                    ...
                    <button class="kelola-guru" onclick="location.href='tabelguru.php'">
                        ...
                        $total = $row['COUNT(*)'];
                        ?>
                        <p> <?php echo $total ?> Guru</p>
                    </button>
                    <button class="kelola-admin" onclick="location.href='tabeladmin.php'">
    ...
    <script>
        ...
        function tambahConfirm() {
            if (c == 0) {
                ...
                setTimeout(() => {
                    window.location.href = 'dokumen_guru.html'
                }, 3000);
                c = 1;
            } else {

...
if (isset($_POST['TambahForum'])) {
  $conn = koneksi();
  header("Location: tambah_forumcategories_siswa.php?Id=$Id");
}
    ...
    <div class="dokumen">
      ...
      <div class="doc-content">
        <div class="doc-header">
          ...
          <div class="search-box1 search-box doc-guru ml-auto">
            <form action="" method="post">
              <span><i class="fa fa-search"></i></span>
              <input type="search" class="keyword" name="keyword" style="background: none !important;border: none;outline: none;height: 20px;font-size: 12px;" placeholder="Search Here"></input>
              <button type="submit" style="width: 20px; display: none;" name="cari" class="tombol-cari">Cari</button>
            </form>
          </div>
        </div>
          ...
          foreach ($forum as $f) : ?>
            <div class="list-forumcateg-item">
                ...
                <div class="logo-forumcateg">
                  ...
                  <div class="dropdown">
                    ...
                    <div id="drop-history" class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                      <a class="dropdown-item" href="edit_forumcategories_siswa.php?Id=<?= $f['Id_ForumCat']; ?>">Edit Forum</a>
                      <a class="dropdown-item" onclick="return confirm('Apakah anda yakin ingin menghapus forum categories ini?')" href="hapusforumcat1.php?Id=<?= $f["Id_ForumCat"] ?>">Delete Forum</a>
                    </div>
                  </div>
                </div>
                <h6><?= $f["Nama"] ?></h6>
              ...
              <div class="jlh-siswa d-flex">
                ...
                <div class="btn-open">
                  <button onclick="location.href='forumthread.php?Id=<?= $f['Id_ForumCat']; ?>'">Open</button>
                </div>
              </div>
            </div>
          <?php endforeach ?>

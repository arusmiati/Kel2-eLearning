...
if (isset($_POST['save'])) {
    ...
    for ($i = 0; $i < count($checkbox); $i++) {
        $del_id = $checkbox[$i];
        mysqli_query($conn, "DELETE FROM user_guru WHERE Id ='" . $del_id . "'");
            ...
            <div class="tabel-content">
                <div class="doc-header kelola d-flex">
                    <div class="head d-flex">
                        ...
                        <div class="icon"><img src="img/teacher1.png" alt=""></div>
                        <?php
                        $conn = koneksi();
                        $user = "SELECT COUNT(*) FROM user_guru";
                ...
                <form action="" method="post" id="delete_form">
                    <div class="del-sel">
                        ...
                        <button onclick="location.href='tambahguru.php'" style="background: #58BAAB;color: white;outline: none;cursor: pointer;"><a style="color: white; text-decoration: none;" href=" tambahguru.php">Tambah Data Guru</a></button>
                    </div>
                    ...
                    <div class="item-tabel">
                        <table>
                            ...
                            <?php
                            $user = querys("SELECT * FROM user_guru");
                            if (isset($_POST['cari'])) {
                                $user = cari_guru($_POST['keyword']);
                            }
                            foreach ($user as $u) : ?>
                                <tr class="item items">
                                    ...
                                    <td>
                                        <div class="opsi">
                                            <button class="edit"><a href="editguru.php?Id=<?= $u["Id"] ?>">edit</a></button>
                                        </div>
                                    </td>

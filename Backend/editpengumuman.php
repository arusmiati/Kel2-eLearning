...
<body>
    ...
    <div class="main-container">
        ...
        <div id="confirm-box-tambah">
            <h1>Pengumuman ini<br> Berhasil Ditambahkan</h1>
        </div>
        <div class="dokumen">
            ...
            <div class="doc-content">
                <div class="doc-header">
                    ...
                    <div class="search-box1 doc-guru ml-auto">
                        <span><i class="fa fa-search"></i><p>Search Bar</p></span>
                    </div>
                </div>
                <div class="add-docs tambah-tugas">
                    ...
                    <div class="title d-flex">
                        <p>Judul</p>
                        <input value="<?=$p["Judul"]?>" type="text" name="judul" placeholder="Ketikkan nama kelas disini">
                    </div>
                    <div class="title d-flex">
                        <p>Deskripsi</p>
                        <textarea name="deskripsi" placeholder="Ketikkan deskripsi tugas disini (optional)"><?=$p["Deskripsi"]?></textarea>
                    </div>
                    ...
                    <div class="click">
                        ...
                        <div class="btn-start">
                            <button type="submit" name="pengumuman" onclick="tambahConfirm()">Edit</button>
                        </div>
                    </div>
                    </form>
                </div>     

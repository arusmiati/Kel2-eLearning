...
if (isset($_POST['Tugas'])) {
    if (EditTugas($_POST) > 0) {
        ...
        echo "<script> alert('tugas gagal diubah')
        </script>";
    }
}
?>
                ...
                <div class="add-docs tambah-tugas">
                    <form action="" method="post" enctype="multipart/form-data" class="dropzone" id="image-upload">
                        ...
                        <div class="title d-flex">
                            <p>Judul</p>
                            <input name="judul_tugas" type="text" value="<?= $tugas['judul_tugas']; ?>" placeholder="Ketikkan nama kelas disini">
                        </div>
                        <div class="title d-flex">
                            <p>Deskripsi</p>
                            <textarea name="deskripsi_tugas" placeholder="Ketikkan deskripsi tugas disini (optional)"><?php echo $tugas['deskripsi_tugas']; ?></textarea>
                        </div>
                        <div class="title d-flex">
                            <p>Batas Pengumpulan</p>
                            <input type="date" name="dl_tugas" value="<?= $tugas['dl_tugas']; ?>" id="">
                            <input type="time" name="jam_dl" value="<?= $tugas['jam_dl']; ?>" id="">
                        </div>
                        <div class="title d-flex">
                            <p>Skor</p>
                            <select class="pilihSemester" name="skor">
                                <option value="<?= $tugas['skor']; ?>">100</option>
                                <option value="<?= $tugas['skor']; ?>">Tidak Dinilai</option>
                            </select>
                        </div>
                        <div class="title d-flex">
                            <p>Lampiran</p>
                            <input id="upfile" type="file" name="NamaFile" multiple value="<?= $tugas['lampiran']; ?>" />
                        </div>
                        <div class=" click">
                            <div class="btn-back">
                            ...
                            <div class="btn-start">
                                <button name="Tugas" type="submit" onclick="return confirm('Apakah Anda Yakin Ingin Mengubah Tugas Ini?');">Edit</button>
                            </div>
                        </div>
                    </form>
                </div>

...
<body>
    ...
    <div class="main-container">
        ...
        <div class="tabel">
            <div class="tabel-content doc-content kelola-ujian">
                <div class="doc-header d-flex">
                    <span><a href="javascript:history.back()"><i class="fa fa-arrow-left"></i></a> </span>
                    <h1>Detail Ulangan Harian</h1>
                </div>
                <div class="item-kelola">
                    <button class="kelola-siswa" onclick="location.href='listsoal.php?Id=<?= $Id ?>'">
                        <p>View <br> Question</p>
                    </button>
                    <button class="kelola-guru" onclick="location.href='detailkerjasiswa.php?Id=<?= $ujian['Id_Mapel'] ?>'">
                        <p>Detail <br> Student</p>
                    </button>
                </div>
            </div>
        </div>

          ...
          <div class="forumthread-content">
            <div class="main-item">
              <div class="foto">
                ...
                <h5><?= $forum["NamaUser"] ?></h5>
              </div>
              <div class="tambah-komentar">
                <div class="forumthread-title">
                  <h5><b><?= $forum["JudulReply"] ?></b></h5>
                  <p><?= nicetime($forum["WaktuReply"]) ?></p>
                </div>
                <div class="forumthread" style="padding-bottom: 1vh;">
                  <p><?php echo $forum["DeskripsiReply"] ?></p>
                </div>
              </div>
            </div>
        ...
        <div class="add-docs tambah-tugas reply">
          <form action="" method="post" enctype="multipart/form-data" class="dropzone" id="image-upload">
            <div class="title d-flex">
              <p>Judul</p>
              <input class="forum" name="forum" type="text" value="<?= $forum["JudulReply"] ?>" placeholder="Ketikkan judul forum disini">
            </div>
            ...
            <div class="click">
              ...
              <div class="btn-start">
                <button name="Reply" type="submit">Tambah</button>
              </div>
            </div>
          </form>
        </div>

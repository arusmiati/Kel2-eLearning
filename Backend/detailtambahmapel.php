...
<body>
    ...
    <div class="main-container">
        <div id="confirm-box">
            ...
            <a href="login.php" class="yes">Iya</a>
        ...
        <div class="dokumen">
            ...
            <div class="doc-content">
               <div class="doc-header">
                    <div class="d-flex">
                        <span><a href="kelas.php"><i class="fa fa-arrow-left"></i></a> </span>
                ...
                <form action="" method="post" enctype="multipart/form-data" class="dropzone" id="image-upload">
                    ...
                    <div class="click">
                        ...
                        <div class="btn-start">
                            <button name="Tambah" type="submit" onclick="return confirm('Apakah Anda Yakin Ingin Menambahkan Kelas ini?')">Tambah</button>
                        </div>
                    </div>
                    </form>
                </div>

...
$ujian = querys("SELECT * FROM ujian WHERE Id_Mapel = '$Id_Mapel'");
if (isset($_POST['cari'])) {
    $ujian = cari_ujian($_POST['keyword']);
}
            ...
            <div class="doc-content">
                <div class="doc-header">
                    <div class="d-flex">
                        ...
                        <div class="btn-start ml-auto">
                            <button onclick="location.href='tambahujian.php?Id=<?= $Id_Mapel; ?>'">Tambah</button>
                        </div>
                    </div>
                ...
                <div class="ujian-list">
                    <div class="ujian-head">
                        <table>
                            <tr class="title">
                                <th class="th1">Nama Ulangan</th>
                                <th class="th2">Status</th>
                            </tr>
                            <tr class="isi">
                                <?php foreach ($ujian as $u) : ?>
                                    <td class="td1"><a href="detailujianguru.php?Id=<?php echo $u["id_ujian"] ?>"><?php echo $u["judul_ujian"] ?></a> </td>
                                    <td class="td2">Aktif Pada Tanggal <?php echo date("D, j F Y H:i", strtotime($u["Waktu_Aktif"])) ?> - <?php echo date("D, j F Y H:i", strtotime($u["Waktu_Berakhir"])) ?></td>
                                <?php endforeach ?>
                            </tr>
                        </table>
                    </div>

...
<body>
  ...
  <div class="container">
    <div class="content-slide">
      ...
      foreach ($slide as $s) : ?>
        <div class="imgslide">
          <div class="editslide"><button onclick="location.href='editslide.php?Id=<?= $s['id_slide'] ?>'" class="edit"><i class="fa fa-pencil"></i></button></div>
    ...
    <div class="content-announcements">
      ...
      <div class="announcement">
        ...
        <?php endif ?>
        <a id="announcement" href="announcement_admin.php">Announcement</a>
        <a id="announcement" href="announcement_admin.php">&#10095;</a>
        <?php $i = 1;
        foreach ($al as $i => $al) :  ?>

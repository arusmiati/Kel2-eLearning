...
if (isset($_POST['Daftar'])) {
    ...
    $mapel = "INSERT INTO matapelajaran VALUES (null,'$nama_mapel', '$nama_guru', 0, '$hari', '$waktu', '$semester','$sampul','$tkls', '$desk','$Id_Kelas')";
    mysqli_query($conn, $mapel)  or die(mysqli_error($conn));

    $siswa = "INSERT INTO siswa_terdaftar VALUES (null, '$Nama', '$Nis', '$Id_Kelas')";
    mysqli_query($conn, $siswa);
...
<body>
    <?php require_once('navbar/navbarcari.php') ?>

            ...
            <div class="doc-content">
                <div class="doc-header">
                    <div class="d-flex">
                        ...
                        <h1>Tugas</h1>
                        <div class="btn-start ml-auto upload-btn-wrapper">
                            <button name="TambahTugas" onclick="location.href='tambahtugas.php?Id=<?= $Id_Mapel; ?>'">Tambah Tugas</button>
                        </div>
                    </div>
                    ...
                    foreach (array_reverse($tugas) ?: [] as $k) : ?>
                        <div class="tugas-list-item">
                            <div class="title-tugas d-flex">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div id="drop-history" class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="edittugas.php?Id=<?= $k['Id_Tugas']; ?>">Edit Tugas</a>
                                        <a class="dropdown-item" href="hapustugas.php?id=<?= $k['Id_Tugas']; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Tugas Ini?');">Delete Tugas</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="btn-start ml-auto">
                                <button onclick="location.href='detailtugasguru.php?Id=<?= $k['Id_Tugas']; ?>'">Detail</button>
                            </div>
                        </div>
                    <?php endforeach ?>
                </div>

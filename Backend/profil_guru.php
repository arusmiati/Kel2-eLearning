    ...
    <div class="profil-header">
        <div class="profil-sidebar">
            <div class="button">
                ...
                $user = query("SELECT * FROM user_guru WHERE Nama = '$nama'");
                ?>
                <button type="button" id="password" class="profil-sidebar-page " onclick="location.href='password_guru.php?Id=<?=$user["Id"]?>'">
        ...
        <div class="profil-user">
            ...
            <form class="field-user" >
                <div class="container-field-user">
                    ...
                    <br>
                    <br>
                    <button><a href="editprofilguru.php?Id=<?= $user["Id"]?>" style="text-decoration: none; color: white">Edit Profile</a></button>
                    <br><br>
                </div>

            ...
            <div class="tabel-content doc-content">
                ...
                <div class="add-docs tambah-tugas">
                    ...
                    <div class="title d-flex">
                        <p>Judul</p>
                        <input type="text" name="judul" placeholder="Ketikkan nama kelas disini">
                    </div>
                    <div class="title d-flex">
                        <p>Deskripsi</p>
                        <textarea name="deskripsi" placeholder="Ketikkan deskripsi tugas disini (optional)"></textarea>
                    </div>
                    ...
                    <div class="click">
                        ...
                        <div class="btn-start">
                            <button type="submit" name="pengumuman" onclick="tambahConfirm()">Tambah</button>
                        </div>
                    </div>
                    </form>
                </div>     
